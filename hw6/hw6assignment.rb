...
class MyPiece < Piece
  ...
  # TODO: toknow whether change All_pieces here would affect Piece
...
class MyBoard < Board
  ...
  #this function is used to solve the bug in class Board's store_current
  def store_current
    locations = @current_block.current_rotation
    displacement = @current_block.position
    (0..locations.length - 1).each{ |index|  # locations.lenght -1, instead of 3, which requies 4 blocks
